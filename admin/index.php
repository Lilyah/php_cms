    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <!-- /.row -->
                        ...
                        <div class="panel panel-red">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <?php
                                        /* Counting the categories for the admin dashboard */
                ...
                /* Draft posts for the chart in dashboard */
                $query = "SELECT * FROM posts WHERE post_status = 'draft'";
                $select_all_draft_posts = mysqli_query($connection, $query);
                $post_draft_count = mysqli_num_rows($select_all_draft_posts);

                /* Unapproved/pending comments for the chart in dashboard */
                $query = "SELECT * FROM comments WHERE comment_status = 'Unapproved'";
                $select_all_unapproved_comments = mysqli_query($connection, $query);
                $unapproved_comments_count = mysqli_num_rows($select_all_unapproved_comments);

                /* Subscribers for the chart in dashboard */
                    ...
                    <script type="text/javascript">
                        ...
                        function drawChart() {
                            var data = google.visualization.arrayToDataTable([
                                ...
                                //['Posts', 1000],  code from javascript
