...
//    $salt = $row['randSalt'];
//    $password = crypt($password, $salt); // crypt the passwords due registration;
//                                         // also need to reverse the crypt so the user could login
//                                         // the reverse is in login.php
